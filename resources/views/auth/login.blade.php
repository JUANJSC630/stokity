...
@section('login')
<div class="vh-100 d-flex align-items-center justify-content-center" style="background: url('{{ asset('plantilla/back.png') }}'); background-size: cover; background-position: center;">
  <div class="col-12 col-sm-8 col-md-6 col-lg-4">
    ...
    <div class="text-center mt-4">
      <small class="text-light">© {{ date('Y') }} TuApp MegaWow. Todos los derechos reservados.</small>
    </div>
  </div>
</div>
@endsection